...
const TermsOfUseModal = () => {
  const { isTermsOpen, setTermsOpen } = useAppContext();
      ...
      >
        ...
        <div className="p-6 md:p-8 overflow-y-auto text-sm text-gray-700 leading-relaxed space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-50 p-4 rounded-lg space-y-1 text-xs border border-gray-100">
          ...
          <div className="text-xs text-gray-500 font-semibold pt-2 text-right">
