...
export default function SubmitDisclosurePage() {
      ...
      switch (subStep) {
        case 0:
          return {
            ...
            subtext: "By clicking the \"Agree and Submit\" button below, you agree to the terms in our Electronic Delivery Consent.",
            component: (
        ...
        case 1:
          return {
            title: "Loan Application and Solicitation Disclosure",
            subtext: "This document provides basic information about the loan you’re applying for, including rates, fees, and loan cost examples.",
            component: <SolicitationDisclosure />
          };
        case 2:
          return {
            title: "Privacy Notice",
            subtext: "By clicking ‘Agree and submit’ you agree to receive Privacy Notices from us electronically and you acknowledge receipt of our Privacy Notice.",
            component: <PrivacyNotice />
          };
        default:
          return { title: "", subtext: "", component: null };
      }
    };

    const { title, subtext, component } = getContentData();
    ...
    return (
      <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div className={`
          ...
          ${isReadMore ? 'max-h-[10000px]' : 'max-h-[500px]'}
        `}>
  ...
  const getStepIcon = () => {
    return <MousePointerClick className="w-10 h-10" />;
  };

  const getStepTitle = () => {
    return <>Your application is <span className="text-accent-blue">ready to go!</span></>;
  };
